...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
    ...
    <form action="resultat_AAu.php" method="post" id="monFormulaire">
        <label for="Email" id="black">Adresse mail</label>
        <input type="email" id="Email" name="Email" placeholder="Votre adresse mail..." maxlength="200" required>

    <label for="Identifiant" id="black">Identifiant</label>
    <input type="text" id="Identifiant" name="identifiant" placeholder="Votre identifiant..." maxlength="200" required>
