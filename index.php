...
<head>
    <title>Accueil - Lion des Flandres</title>
    <meta charset="utf-8">
    ...
    <meta name="keywords" content="Portfolio, BTS SIO, Arthur, Augis, SIO, SLAM, SFDA37, SFDA, BTS, Projets, Connexion">
            ...
            <div>
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="PHP/login_AAu.php">Se connecter</a></li>
                        <li><a href="PHP/contact_AAu.php">Contact</a></li>
